...
vtable_ptr create_object_vtable(){
	...
	return vtable_ptr(new vtable("", "object", method_ptr(), method_ptr(), std::move(methods), std::move(fields), 0, true));
}
...
vtable_ptr create_string_vtable(const vtable& base){
	...
	vtable_ptr ret(new vtable("", "string", method_ptr(), method_ptr(), std::move(methods), std::move(fields), 0, true));
...
vtable_ptr create_number_vtable(const vtable& base){
	...
	vtable_ptr ret(new vtable("", "number", method_ptr(), method_ptr(), std::move(methods), std::move(fields), 0, true));
	ret->derive_from(base);
	return ret;
}
...
vtable_ptr create_function_vtable(const vtable& base){
	...
	vtable_ptr ret(new vtable("", "function", method_ptr(), method_ptr(), std::move(methods), std::move(fields), 0, true));
	ret->derive_from(base);
	return ret;
}
...
vtable_ptr create_null_vtable(const vtable& base){
	...
	vtable_ptr ret(new vtable("", "null", method_ptr(), method_ptr(), std::move(methods), std::move(fields), 0, true));
	ret->derive_from(base);
	return ret;
}
